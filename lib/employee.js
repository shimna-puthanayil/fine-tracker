...
class Employee {
    ...
    updateEmployeeRole = (employee, callback) => {
        return new Promise((resolve, reject) => {
    ...
    updateManager = (employee, callback) => {
        return new Promise((resolve, reject) => {
            const sql = `UPDATE  employee SET manager_id=(?) WHERE id=(?) `;
            console.log(sql)
            const params = [employee.managerId, employee.employeeId];
            this.db.promise().query(sql, params)
                .then(() => {
    ...
    getAllEmployeesByManager = (managerId, callback) => {
        return new Promise((resolve, reject) => {
    ...
    getAllEmployeesByDepartment = (departmentId, callback) => {
        return new Promise((resolve, reject) => {
